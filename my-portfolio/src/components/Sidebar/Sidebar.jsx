...
const Sidebar = () => {
	...
	return (
		<div
			className={`fixed top-0 left-0 flex flex-col h-full overflow-y-auto overflow-hidden text-nowrap py-4 bg-gray-950 shadow-2xl shadow-cyan-400/30 transition-all duration-300 ease-in-out ${
				isToggled ? "w-64" : "w-20"
			}`}
		>
			{/* Toggle Button */}
